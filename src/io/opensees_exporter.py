...
class OpenSeesExporter:
    """Class for exporting models to OpenSees TCL script format"""
    ...
    def export(self, file_path):
        """Export the project to an OpenSees TCL script"""
    ...
    def _write_header(self, file):
        ...
        file.write("# OpenSees Model exported from Modsee\n")
    ...
    def _write_model_init(self, file):
        ...
        file.write("model BasicBuilder -ndm {} -ndf {}\n\n".format(
    ...
    def _write_analysis(self, file):
        ...
        file.write("system BandSPD\n")
        
        # Create the constraint handler
        file.write("constraints Plain\n")
        
        # Create the integrator
        file.write("integrator LoadControl 1.0\n")
    ...
    def _write_recorders(self, file):
        ...
        file.write("recorder Node -file node_disp.out -time -node all -dof 1 2 3 disp\n")
        file.write("recorder Element -file element_forces.out -time -ele all forces\n\n")
        
    def _write_footer(self, file):
        """Write the file footer"""
        file.write("# Print to screen that analysis is complete\n")
        file.write("puts \"Analysis complete.\"\n")
        file.write("wipe\n") 